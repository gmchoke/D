...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/gmchoke/A/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
...
# konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://raw.githubusercontent.com/gmchoke/A/master/client-1194.conf"
